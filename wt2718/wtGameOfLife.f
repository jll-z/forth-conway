...
: TEMPERATURE SIZE * ALIVE @ T @ * + 1 T @ + SIZE * RND > IF 1 ELSE 0 THEN ;
...
: FILLRANDOM DUP SIZE > IF DROP SIZE THEN DEPTH 0 = IF SIZE 2 / THEN BEGIN DUP 1 ROWS BOARD @ RND COLUMNS BOARD @ RND BOARD c! COUNTALIVE ALIVE @ = UNTIL DROP ;
