...
INCLUDING-OPTION C:\Users\Joe\Documents\Forth\Forth_Project` bmp-display.f 
...
: run_conway
    ...
    iterations 0 do 
        ...
        wrap 0= if 
            ...
            matrix no_wrap
        then 
        new_matrix matrix change_statistics
